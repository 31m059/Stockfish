...
namespace {
  ...
  // Pawn penalties
  constexpr Score Backward = S(14, 20);
  constexpr Score Doubled  = S(15, 70);
  constexpr Score Isolated = S( 8, 23);
  constexpr Score WeakUnopposed = S( 19, 16);
  constexpr Score Attacked2Unsupported = S( 0, 30);
