...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(269,-10), S(319, 44), S(272, 83), S(190, 93) },
   { S(276, 52), S(302, 96), S(237,133), S(186,129) },
   { S(199, 83), S(255,131), S(168,162), S(118,172) },
   { S(173,104), S(188,152), S(129,169), S(106,177) },
   { S(144,103), S(171,159), S(116,200), S( 72,189) },
   { S(124, 84), S(158,161), S( 85,176), S( 36,188) },
   { S( 89, 40), S(126, 97), S( 74,132), S( 28,141) },
   { S( 67,  6), S( 79, 66), S( 50, 79), S(  3, 74) }
  }
};
...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   ...
   { S( -8,  6), S(-23, -2), S(  6, -8), S( 20, -4), S( 30,-13), S( 17,-12), S(  4,-10), S(-12, -9) },
