...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-42,-55), S(  1,-34), S(-10,-34), S(-26, -6) },
   { S( -6,-36), S(  6,-18), S( 15,-15), S( -1, -5) },
   { S( -9,-10), S( 22, -9), S( -5,  1), S( 12, 12) },
   { S( -1,-23), S(  9,  5), S( 28,  6), S( 37, 16) },
   { S(-11,-19), S( 24,  0), S( 13,-11), S( 28, 16) },
   { S(-13,-29), S(  6,  7), S(  1, -3), S(  6, 16) },
   { S(-24,-32), S(-22,-20), S( 11,-13), S( -9, 18) },
   { S(-44,-50), S( -8,-43), S( -8,-39), S(-25,-24) }
  },
  { // Rook
