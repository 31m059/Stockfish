  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == ROOK)
        {
            ...
            {
                bb  = pos.pieces(Us, PAWN) & ~attackedBy[Them][PAWN] & file_bb(s);
                bb |= pos.pieces(Us, PAWN) & shift<Down>(pos.pieces(Them));
                score += RookOnPawn * popcount(pos.pieces(Them, PAWN) & attacks_bb<ROOK>(s, bb));
            }
