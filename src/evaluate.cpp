...
#undef S
  ...
  Score Evaluation<T>::pieces() {
    ...
    constexpr Color     Them = (Us == WHITE ? BLACK : WHITE);
    constexpr Direction Down = (Us == WHITE ? SOUTH : NORTH);
    constexpr Bitboard OutpostRanks = (Us == WHITE ? Rank4BB | Rank5BB | (Rank6BB & ~(FileABB | FileBBB | FileGBB | FileHBB)) | (Rank7BB & (FileDBB | FileEBB))
                                                   : Rank5BB | Rank4BB | (Rank3BB & ~(FileABB | FileBBB | FileGBB | FileHBB)) | (Rank2BB & (FileDBB | FileEBB)));
