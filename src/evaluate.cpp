...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score RookOnPawn         = S( 12, 36);
  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == ROOK)
        {
            ...
            {
                score += RookOnPawn * popcount(pos.pieces(Them, PAWN) & PseudoAttacks[ROOK][s]) / 2;
                score += RookOnPawn * popcount(pos.pieces(Them, PAWN) & b) / 2;
            }
